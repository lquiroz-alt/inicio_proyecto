<?php
	...
	try{
		...
		$sql = "SELECT fecha, operacion, tiempo_operacion, cuenta, tipo_transaccion, accion, respuesta FROM log WHERE accion='INSERTA' AND tipo_transaccion = 'Deposito'";
		...
		$objPHPExcel->getProperties()->setCreator("FERNANDO AGUILAR")->setDescription("LOG de INSERT - Depositos");
		...
		$objPHPExcel->getActiveSheet()->setCellValue('B3', 'LOG de INSERTAR - Depositos');
	...
	header('Content-Disposition: attachment;filename="insert_depositos.xls"');
