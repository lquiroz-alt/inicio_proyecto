<?php
	...
	try{
		...
		$sql = "SELECT fecha, operacion, tiempo_operacion, cuenta, tipo_transaccion, accion, respuesta FROM `log` WHERE accion='INSERTA' AND tipo_transaccion = 'Retiro'";
		...
		$objPHPExcel->getProperties()->setCreator("FERNANDO AGUILAR")->setDescription("LOG de INSERT - Retiros");
		...
		$objPHPExcel->getActiveSheet()->setCellValue('B3', 'LOG de INSERT - Retiros');
	...
	header('Content-Disposition: attachment;filename="insert_retiro.xls"');
