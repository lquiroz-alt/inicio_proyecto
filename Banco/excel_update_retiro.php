<?php
	...
	try{
		...
		$sql = "SELECT fecha, operacion, tiempo_operacion, cuenta, tipo_transaccion, accion, respuesta FROM log WHERE accion='ACTUALIZAR' AND tipo_transaccion = 'Retiro'";
		...
		$objPHPExcel->getProperties()->setCreator("FERNANDO AGUILAR")->setDescription("LOG de ACTUALIZAR - Retiros");
		...
		$objPHPExcel->getActiveSheet()->setCellValue('B3', 'LOG de ACTUALIZAR - Retiros');
	...
	header('Content-Disposition: attachment;filename="update_retiros.xls"');
